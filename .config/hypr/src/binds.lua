...
hl.bind(
  ...
  hl.dsp.exec_cmd('pactl set-sink-volume @DEFAULT_SINK@ +5% && swayosd-client --output-volume raise --max-volume 100')
)
hl.bind(
  'XF86AudioLowerVolume',
  hl.dsp.exec_cmd('pactl set-sink-volume @DEFAULT_SINK@ -5% && swayosd-client --output-volume lower --max-volume 100')
)
...
hl.bind(
  ...
  hl.dsp.exec_cmd('pactl set-source-volume @DEFAULT_SOURCE@ +5 && swayosd-client --input-volume raise --max-volume 100')
)
hl.bind(
  'SHIFT + XF86AudioLowerVolume',
  hl.dsp.exec_cmd('pactl set-source-volume @DEFAULT_SOURCE@ -5 && swayosd-client --input-volume lower --max-volume 100')
)
